...
class EuroBertRotaryEmbedding(nn.Module):
    def __init__(self, config: EuroBertConfig, device=None):
        ...
        self.register_buffer("inv_freq", inv_freq, persistent=True)  # FIXED
    ...
    def _dynamic_frequency_update(self, position_ids, device):
        ...
        if seq_len > self.max_seq_len_cached:  # growth
            ...
            self.register_buffer("inv_freq", inv_freq, persistent=True)  # FIXED  # TODO joao: may break with compilation
